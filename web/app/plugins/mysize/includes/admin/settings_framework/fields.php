...
$fields['general']['general'][] = array(
    'id' => PLUGIN_DB . 'retailer_token_textbox',
    'multiple' => 'true',
    'type'    => 'text',
    'label' => __('Retailer Token',PLUGIN_TXT),
    'desc' => __('Your Retailer Token',PLUGIN_TXT), 
    'attr'    => array( 
        'multiple' => 'multiple'
    ),
);
...
$fields['general']['general'][] = array(
    'id' => PLUGIN_DB . 'integration_code_textbox',
    'multiple' => 'true',
    'type'    => 'text',
    'label' => __('Integration Code',PLUGIN_TXT),
    'desc' => __('TextBox',PLUGIN_TXT), 
    'attr'    => array( 
        'multiple' => 'multiple'
    ),
);
